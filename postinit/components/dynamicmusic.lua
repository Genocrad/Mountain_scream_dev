...
AddPlayerPostInit(function(inst)
    ...
    if not TheNet:IsDedicated() then
      inst:DoTaskInTime(2, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(4, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(6, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(8, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(10, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(12, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(14, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(16, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(18, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(20, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(22, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(24, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
      inst:DoTaskInTime(26, function(inst) if inst.event_listeners["attacked"] ~= nil and inst.event_listeners["attacked"][TheWorld] ~= nil and not music_was_set_upped then music_was_set_upped = true musicsetup(inst) end end)
    end
  end)
