...
local function onterraformingfinished(inst)
  ...
  inst.components.dungeonwallspawner:SpawnWallsAroundPoint(2, "", 65, WORLD_TILES.MS_MOUNTAIN_LOW_2_TECHNICAL)
  inst.components.dungeonwallspawner:SpawnWallsAroundPoint(3, "", 45, WORLD_TILES.MS_MOUNTAIN_LOW_2_TECHNICAL)
  inst.components.dungeonwallspawner:SpawnWallsAroundPoint(4, "", 35, WORLD_TILES.MS_MOUNTAIN_LOW_2_TECHNICAL)
  inst.components.dungeonwallspawner:SpawnWallsAroundPoint(5, "_high", 35, WORLD_TILES.MS_MOUNTAIN_HIGH_TECHNICAL)
  inst.components.dungeonwallspawner:SpawnWallsAroundPoint(6, "_high", 35, WORLD_TILES.MS_MOUNTAIN_HIGH_TECHNICAL)
  inst.components.dungeonwallspawner:SpawnWallsAroundPoint(7, "_snow", 25, WORLD_TILES.MS_PERMAFROST_TECHNICAL)
...
AddPrefabPostInit("cave", function(inst)
  ...
  inst:AddTag("mountain_scream_dungeons")
    ...
    inst.Map:AddTileCollisionSet(
        ...
        TUNING.MS_TECHNICAL_COLLISION_INSET or -2, 256
    )
