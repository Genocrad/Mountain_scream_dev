...
local COLOUR_ENVELOPE_NAME = "ms_snowcolourenvelope"
local SCALE_ENVELOPE_NAME = "ms_snowscaleenvelope"
local WINTER_SCALE_ENVELOPE_NAME = "ms_wintersnowscaleenvelope"
...
local function fn()
    ...
    local desired_particles_per_second = 300--300
    ...
    local function update_fn()
      ...
      if ThePlayer then
        if ThePlayer.map_level_current and ThePlayer.map_level_current > 6 and ThePlayer.map_level_current <= 10 then
...
return Prefab("ms_fake_snow", fn, assets)
