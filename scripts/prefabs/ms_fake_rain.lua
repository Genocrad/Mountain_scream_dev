...
local COLOUR_ENVELOPE_NAME = "ms_raincolourenvelope"
local SCALE_ENVELOPE_NAME = "ms_rainscaleenvelope"
    ...
    local x, y, z = inst.Transform:GetWorldPosition()
        ...
        while inst.num_splashes_to_emit > 0 do
			...
			if #domes > 0 then
				last_domes = domes
				last_domes_ticks = 30
			elseif map:IsPassableAtPoint(x1, 0, z1) and not IsMsTechnicalTile(TheWorld.Map:GetTileAtPoint(x1, 0, z1)) then
...
return Prefab("ms_fake_rain", fn, assets, prefabs)
