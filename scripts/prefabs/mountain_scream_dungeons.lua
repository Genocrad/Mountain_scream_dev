...
local function common_postinit(inst)
    ...
    inst.WaveComponent:SetWaveParams(13.5, 2.5, -5)    			-- wave texture u repeat, forward distance between waves
...
local function onterraformingfinished(inst)
  inst.components.dungeonwallspawner:SpawnWallsAroundPoint(1, "ms_mountain_wall", 45)
  inst.components.dungeonwallspawner:SpawnWallsAroundPoint(2, "ms_mountain_wall", 45)
end
...
local function master_postinit(inst)
    ...
    inst:AddComponent("dungeonwallspawner")
    inst:ListenForEvent("terraforming_finished", onterraformingfinished)
end

return MakeWorld("mountain_scream_dungeons", prefabs, assets, common_postinit, master_postinit, {"mountain_scream_dungeons"}, {
