...
___________________________DESCRIBE.MS_SHORTCUT = "Нужен подходящий источник энергии."
___________________________DESCRIBE.MS_SHORTCUT_ON = "Короткий путь?"
___________________________DESCRIBE.MS_SHORTCUT_EXIT = "Нужен подходящий источник энергии."
___________________________DESCRIBE.MS_SHORTCUT_EXIT_ON = "Короткий путь?"
